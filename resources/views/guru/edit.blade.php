<div
    class="fixed left-0 right-0 z-50 flex items-center justify-center overflow-x-hidden bg-gray-400 bg-opacity-60 top-0 h-modal md:h-full md:inset-0">
    <div class="relative w-full h-full sm:max-w-lg px-4 md:h-auto ">
        <!-- Modal content -->
                ...
                <div class="shadow sm:rounded-md">
                    <div class="px-4 py-4 space-y-6 bg-white sm:p-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="status"
                                       class="block mb-2 text-sm font-medium text-gray-900">Status Kepegawaian</label>
                    ...
                    <div class="px-4 py-3 text-right bg-gray-50 sm:px-6">
                        <button type="button" wire:click="updateGuruModalClose()"
                        ...
                        <button type="button" wire:click.prevent="update({{ $nip }})"
