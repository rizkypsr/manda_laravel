        ...
        <table class="min-w-full">
            ...
            @forelse ($guru as $b)
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">{{ date('Y/m/d', strtotime($b->created_at))}}</td>
                    <td class="flex px-6 py-4 space-x-4 text-sm font-medium text-right whitespace-nowrap">
                        <button wire:click="edit({{ $b->nip }})"
                        ...
                        <a href="{{ Storage::url($b->user->profile_photo_path) }}" class="text-gray-600 hover:underline">Lihat
                            Gambar</a>
                    </td>
                </tr>
            @empty
