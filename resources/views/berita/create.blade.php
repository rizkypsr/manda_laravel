            ...
            <form>
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-3 space-y-6 bg-white sm:p-6">
                        <div class="font-semibold">Tambah Data Berita</div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="deskripsi" wire:model="deskripsi" rows="6"
                                    class="@error('deskripsi') border-red-500 @enderror w-full px-3 py-2 mt-1 border-gray-300 rounded-md shadow-sm form-textarea focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="px-4 py-3 text-right bg-gray-50 sm:px-6">
                        <button type="button" wire:click="closeCreateModalPopover()"
