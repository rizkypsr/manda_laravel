        ...
        <table class="min-w-full">
            ...
            @forelse ($siswa as $b)
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">{{ strtoupper($b->jenis_kelamin) }}</td>
                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $b->kelas->jurusan->nama }}</td>
